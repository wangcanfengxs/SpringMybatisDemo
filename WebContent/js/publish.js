(function(w,d,u){
	...
	var page = {
		init:function(){
			...
			[title,digest,image,detail,price].forEach(function(item){
		...
		check:function(){
			...
			[
				...
				[digest,function(value){return value.length<2 || value.length>140}],
			...
			if(imageMode == "fileUpload" && !imgpre.src){
